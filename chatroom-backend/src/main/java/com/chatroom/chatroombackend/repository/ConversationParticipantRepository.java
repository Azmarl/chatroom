...
public interface ConversationParticipantRepository extends JpaRepository<ConversationParticipant, ConversationParticipantId> {
    ...
    /**
     * Finds all pending join requests for groups where the specified user is an admin or owner.
     * This is a more complex query that first finds the groups the user manages and then
     * finds pending requests within those groups.
     ...
     */
    @Query("SELECT p_pending FROM ConversationParticipant p_pending " +
